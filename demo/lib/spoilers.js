...
;(function(){
  ...
  for(var i=0; i<spoilers.length; i++) {
    ...
    spoilers[i].innerHTML = '<span class="spoilerTag">'+Spoiler.textShow+'</span> ' + spoilers[i].innerHTML;
  ...
  for(var i=0; i<tags.length; i++) {
    tags[i].style.color = Spoiler.color;
    tags[i].style.backgroundColor = Spoiler.background;
